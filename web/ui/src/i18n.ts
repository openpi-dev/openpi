...
const resources = {
  en: {
    translation: {
      ...
      allProviders: "All",
      modelMetaReasoning: "Reasoning",
      modelMetaImageInput: "Image input",
      modelPickerHints: "↑↓ navigate · Enter select · Esc close",
  ...
  zh: {
    translation: {
      ...
      allProviders: "全部",
      modelMetaReasoning: "思考",
      modelMetaImageInput: "图片输入",
      modelPickerHints: "↑↓ 导航 · Enter 选择 · Esc 关闭",
