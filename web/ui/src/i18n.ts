...
const resources = {
  en: {
    translation: {
      ...
      questionDraftLimit:
        "Question drafts are full. Shorten or clear an existing answer before adding more text.",
      ...
      artifactReferenceUnavailable:
        "File preview is unavailable in this view: {{path}}",
      ...
      restartTerminalTitle: "Restart this terminal?",
      restartTerminalDetail:
        "The current terminal will be closed. Running processes may be interrupted.",
      terminalReconnecting: "Reconnecting terminal...",
      ...
      retryOriginalAdmission: "Retry original message",
      promptTooLong: "Message exceeds the send limit ({{count}} / {{limit}}).",
      ...
      fileReferenceDraftChanged:
        "The draft changed. Reopen the file reference.",
      ...
      renameFailed: "Could not save the name. Your changes were kept.",
      savingName: "Saving...",
      workspaceRemoveFailed: "Could not remove the workspace. Try again.",
  ...
  zh: {
    translation: {
      ...
      closePreview: "关闭预览",
      artifactReadOnly: "只读",
      artifactReferenceUnavailable: "此视图无法打开文件预览：{{path}}",
      ...
      restartTerminalTitle: "重新启动此终端？",
      restartTerminalDetail: "当前终端会被关闭，其中运行的进程可能被中断。",
      ...
      retryOriginalAdmission: "重试原消息",
      promptTooLong: "文本超出发送上限（{{count}} / {{limit}}）。",
      sendAsNew: "作为新消息发送",
      sendingAsNew: "正在发送…",
      addWorkspace: "添加工作区",
      ...
      retryModelSearch: "重试模型搜索",
      fileReferenceDraftChanged: "草稿已变化，请重新打开文件引用。",
      ...
      renameFailed: "无法保存名称，已保留你的修改。",
      savingName: "正在保存...",
      workspaceRemoveFailed: "无法移出工作区，请重试。",
      removingWorkspace: "正在移出...",
