...
const resources = {
  en: {
    translation: {
      ...
      workspaceChangesHeading: "Workspace changes",
      workspaceChangesRefresh: "Refresh workspace changes",
      workspaceChangesLoading: "Reading workspace changes…",
      workspaceChangesChanged:
        "The active workspace changed. Refresh the view.",
      workspaceChangesUnavailable: "Workspace changes are unavailable.",
      workspaceChangesWorkspace: "Workspace",
      workspaceChangesComparison: "Comparison",
      workspaceChangesHead: "HEAD {{commit}}",
      workspaceChangesEmptyTree: "Empty tree (no HEAD)",
      workspaceChangesClean: "Working tree is clean.",
      workspaceChangesNotRepository: "This workspace is not a Git repository.",
      workspaceChangesStatusTruncated:
        "The Git status list exceeded the display limit; the list may be incomplete.",
      workspaceChangesTruncated:
        "Some workspace change details are truncated to keep this view bounded.",
      workspaceChangesFilesOmitted: "{{count}} files omitted.",
      workspaceChangesDiffsTruncated: "{{count}} diffs truncated.",
      workspaceChangesFiles: "Changed files",
      workspaceChangesDiff: "File diff",
      workspaceChangesBinaryShort: "binary",
      workspaceChangesBinary: "Binary file; no textual diff is available.",
      workspaceChangesDiffUnavailable:
        "This diff could not be read. Refresh to try again.",
      workspaceChangesNoDiff: "No textual diff is available for this file.",
      workspaceChangesDiffTruncated:
        "This file diff is truncated; refresh cannot expand the bounded view.",
      workspaceChangesNoFiles:
        "Git reported changes, but no file details are available.",
      workspaceChangesSelectFile: "Select a file to inspect its diff.",
      workspaceChangesCheckedAt:
        "Checked at {{time}} · refresh for the latest state",
      workspaceChangesStatus_added: "Added",
      workspaceChangesStatus_copied: "Copied",
      workspaceChangesStatus_deleted: "Deleted",
      workspaceChangesStatus_modified: "Modified",
      workspaceChangesStatus_renamed: "Renamed",
      workspaceChangesStatus_unmerged: "Unmerged",
      workspaceChangesStatus_untracked: "Untracked",
  ...
  zh: {
    translation: {
      ...
      workspaceChanges: "改动",
      workspaceChangesHeading: "工作区改动",
      workspaceChangesRefresh: "刷新工作区改动",
      workspaceChangesLoading: "正在读取工作区改动…",
      workspaceChangesChanged: "当前工作区已变化，请刷新此视图。",
      workspaceChangesUnavailable: "暂时无法读取工作区改动。",
      workspaceChangesWorkspace: "工作区",
      workspaceChangesComparison: "比较基准",
      workspaceChangesHead: "HEAD {{commit}}",
      workspaceChangesEmptyTree: "空树（尚无 HEAD）",
      workspaceChangesClean: "工作区没有改动。",
      workspaceChangesNotRepository: "当前工作区不是 Git 仓库。",
      workspaceChangesStatusTruncated:
        "Git 状态列表超过显示上限，当前列表可能不完整。",
      workspaceChangesTruncated: "部分工作区改动已截断，以限制视图大小。",
      workspaceChangesFilesOmitted: "省略 {{count}} 个文件。",
      workspaceChangesDiffsTruncated: "{{count}} 个 Diff 已截断。",
      workspaceChangesFiles: "改动文件",
      workspaceChangesDiff: "文件 Diff",
      workspaceChangesBinaryShort: "二进制",
      workspaceChangesBinary: "二进制文件，没有可显示的文本 Diff。",
      workspaceChangesDiffUnavailable: "暂时无法读取此 Diff，请刷新重试。",
      workspaceChangesNoDiff: "此文件没有可显示的文本 Diff。",
      workspaceChangesDiffTruncated:
        "此文件 Diff 已截断；刷新也不会突破视图上限。",
      workspaceChangesNoFiles: "Git 报告存在改动，但暂时无法提供文件详情。",
      workspaceChangesSelectFile: "请选择一个文件查看 Diff。",
      workspaceChangesCheckedAt: "采集于 {{time}} · 刷新查看最新状态",
      workspaceChangesStatus_added: "新增",
      workspaceChangesStatus_copied: "复制",
      workspaceChangesStatus_deleted: "删除",
      workspaceChangesStatus_modified: "修改",
      workspaceChangesStatus_renamed: "重命名",
      workspaceChangesStatus_unmerged: "未合并",
      workspaceChangesStatus_untracked: "未跟踪",
      runtimeStatus: "运行状态",
      refreshStatus: "刷新状态",
