...
const resources = {
  en: {
    translation: {
      ...
      failedTurn: "Current turn failed.",
      uncertainTurn: "Current turn outcome is uncertain.",
      assistantFailed: "Assistant response failed.",
      assistantStopped: "Assistant response stopped before completion.",
  ...
  zh: {
    translation: {
      ...
      stoppedTurn: "当前轮次已停止。",
      failedTurn: "当前轮次失败。",
      uncertainTurn: "当前轮次结果不确定。",
      assistantFailed: "助手回复失败。",
      assistantStopped: "助手回复在完成前停止。",
