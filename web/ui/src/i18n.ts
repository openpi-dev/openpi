...
const resources = {
  en: {
    translation: {
      ...
      noLoadedArchives: "No archived conversations found.",
      restoreFailed: "Could not confirm restoration. Refresh and try again.",
      terminalHistory: "Terminal history",
      terminalHistoryDetail: "Terminal session history",
      terminalSource: "Pi default sessions · Terminal · read-only",
      terminalChooseWorkspace:
        "Select a workspace to inspect its terminal sessions.",
      terminalHistoryEmpty: "No terminal sessions in this workspace.",
      terminalTextOnly:
        "Read-only text excerpt from Pi history. Non-text evidence is not shown.",
      terminalHistoryPartial:
        "Showing {{shown}} of {{total}} messages; earlier or oversized content was omitted.",
      terminalNonText: "Non-text content not shown",
      historyLoading: "Loading history…",
      historyLoadFailed: "Could not load history.",
      historyRetry: "Retry",
      historyPartial: "History scan is partial; some records may not be shown.",
      historyMore: "Load more",
      historyEnd: "End of available history",
  ...
  zh: {
    translation: {
      ...
      noLoadedArchives: "没有找到已归档会话。",
      restoreFailed: "暂时无法确认恢复结果，请刷新后重试。",
      terminalHistory: "终端历史",
      terminalHistoryDetail: "终端会话历史",
      terminalSource: "Pi 默认会话 · 终端 · 只读",
      terminalChooseWorkspace: "选择工作区后可查看其终端会话。",
      terminalHistoryEmpty: "当前工作区没有终端会话。",
      terminalTextOnly: "这是 Pi 历史的只读文本片段；非文本证据未显示。",
      terminalHistoryPartial:
        "显示 {{shown}} / {{total}} 条消息；更早或过大的内容已省略。",
      terminalNonText: "非文本内容未显示",
      historyLoading: "正在加载历史…",
      historyLoadFailed: "无法加载历史。",
      historyRetry: "重试",
      historyPartial: "历史扫描不完整，可能有记录未显示。",
      historyMore: "加载更多",
      historyEnd: "已到可用历史末尾",
