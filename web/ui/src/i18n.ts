...
const resources = {
  en: {
    translation: {
      ...
      artifactClosePreview: "Close preview",
      artifactReadOnlySession: "Read-only access · Session {{sessionId}}",
      artifactRefresh: "Refresh",
      artifactDownload: "Download",
      artifactDownloading: "Downloading…",
      artifactOlderPreview: "Showing an older preview.",
      artifactReading: "Reading file…",
      artifactVersion: "Version",
      artifactBytes: "{{bytes}} bytes",
      artifactTruncated:
      ...
      artifactPreviewContent: "File preview content",
      artifactReadFailed: "Unable to read file",
      artifactDownloadFailed: "Download failed",
      artifactError_ARTIFACT_DENIED:
        "This file is outside the allowed Session workspace or its identity could not be verified.",
      artifactError_ARTIFACT_LIMIT:
        "Too many open files. Close a preview before opening another.",
      artifactError_ARTIFACT_EXPIRED:
        "File access expired. Open the file again from its Session.",
      artifactError_ARTIFACT_BUSY: "File reads are busy. Try again shortly.",
      artifactError_ARTIFACT_UNSUPPORTED: "Only regular files can be opened.",
      artifactError_ARTIFACT_TOO_LARGE:
        "File exceeds the 20 MiB read/download limit.",
      artifactError_ARTIFACT_CHANGED:
        "File changed. Refresh before downloading or viewing a stable version.",
      artifactError_ARTIFACT_MISSING: "File no longer exists.",
      artifactError_ARTIFACT_READ_ERROR: "Unable to read this file.",
      artifactError_ARTIFACT_DOWNLOAD_BODY: "Download body is unavailable.",
  ...
  zh: {
    translation: {
      ...
      artifactClosePreview: "关闭预览",
      artifactReadOnlySession: "只读访问 · 会话 {{sessionId}}",
      artifactRefresh: "刷新",
      artifactDownload: "下载",
      artifactDownloading: "正在下载…",
      artifactOlderPreview: "当前显示的是旧版预览。",
      artifactReading: "正在读取文件…",
      artifactVersion: "版本",
      artifactBytes: "{{bytes}} 字节",
      artifactTruncated: "预览已截断。下载文件可查看完整内容。",
      artifactUnsupported: "无法预览此文件类型，请下载查看。",
      artifactPreviewContent: "文件预览内容",
      artifactReadFailed: "无法读取文件",
      artifactDownloadFailed: "下载失败",
      artifactError_ARTIFACT_DENIED:
        "文件不在当前会话允许的工作区内，或无法核实其身份。",
      artifactError_ARTIFACT_LIMIT: "打开的文件过多，请先关闭一个预览。",
      artifactError_ARTIFACT_EXPIRED: "文件访问已过期，请从所属会话重新打开。",
      artifactError_ARTIFACT_BUSY: "文件读取繁忙，请稍后重试。",
      artifactError_ARTIFACT_UNSUPPORTED: "只能打开普通文件。",
      artifactError_ARTIFACT_TOO_LARGE: "文件超过 20 MiB 的读取或下载上限。",
      artifactError_ARTIFACT_CHANGED: "文件已变更，请刷新后再预览或下载。",
      artifactError_ARTIFACT_MISSING: "文件已不存在。",
      artifactError_ARTIFACT_READ_ERROR: "无法读取此文件。",
      artifactError_ARTIFACT_DOWNLOAD_BODY: "下载内容不可用。",
