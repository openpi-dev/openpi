...
const resources = {
  en: {
    translation: {
      ...
      subagentOrigin_model: "Model delegation",
      subagentOrigin_btw: "User aside",
      subagentProgress: "Progress",
      subagentProgressValue: "{{turns}} turns · {{items}} records",
      subagentTools: "Recent tools",
      subagentToolsOmitted: "{{count}} earlier tools omitted.",
      subagentLatestOutput: "Latest output",
  ...
  zh: {
    translation: {
      ...
      subagentDetails: "子代理详情",
      subagentModel: "子代理模型",
      subagentOrigin: "来源",
      subagentOrigin_model: "模型委派",
      subagentOrigin_btw: "用户旁注",
      subagentProgress: "进度",
      subagentProgressValue: "{{turns}} 轮 · {{items}} 条记录",
      subagentTools: "近期工具",
      subagentToolsOmitted: "省略前面 {{count}} 个工具。",
      subagentLatestOutput: "最新输出",
